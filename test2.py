...
nfa.graph.attr(rankdir='LR')  #all nodes are in horizontal order(Left to Right)
    ...
    for al in range((nfa.no_alphabet) - 1):
        ...
        # This is a dead state(ϕ) in DFA
            ...
            if (-1) not in dfa_states:
                ...
                # For new dead state, add all transistions to itself,
...
# Makes a png with name dfa.png and views the png
